...
impl<'de> Decode<'de> for CapabilitySet {
    fn decode(src: &mut ReadCursor<'de>) -> DecodeResult<Self> {
        ...
        // Try to parse the version, but gracefully handle unknown versions
        // by treating them as Unknown instead of erroring out
        let version = CapabilityVersion::from_u32(version_raw);

        match version {
            Some(CapabilityVersion::V8) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V8 {
                    flags: CapabilitiesV8Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V8_1) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V8_1 {
                    flags: CapabilitiesV81Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V10) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V10 {
                    flags: CapabilitiesV10Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V10_1) => {
                ensure_size!(in: cur, size: 16);
                cur.read_u128();
                Ok(CapabilitySet::V10_1)
            }
            Some(CapabilityVersion::V10_2) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V10_2 {
                    flags: CapabilitiesV10Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V10_3) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V10_3 {
                    flags: CapabilitiesV103Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V10_4) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V10_4 {
                    flags: CapabilitiesV104Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V10_5) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V10_5 {
                    flags: CapabilitiesV104Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V10_6) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V10_6 {
                    flags: CapabilitiesV104Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V10_6Err) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V10_6Err {
                    flags: CapabilitiesV104Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            Some(CapabilityVersion::V10_7) => {
                ensure_size!(in: cur, size: 4);
                Ok(CapabilitySet::V10_7 {
                    flags: CapabilitiesV107Flags::from_bits_truncate(cur.read_u32()),
                })
            }
            // Unknown version: treat as Unknown variant and skip the data
            _ => Ok(CapabilitySet::Unknown(data.to_vec())),
        }
    }
}
