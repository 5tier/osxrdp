...
pub enum DisplayUpdate {
    Resize(DesktopSize),
    Bitmap(BitmapUpdate),
    /// H.264 AVC420 encoded frame (sent via RDPGFX pipeline)
    Avc420(Avc420Update),
...
/// H.264 AVC420 encoded frame update.
///
/// Carries VideoToolbox-encoded H.264 NAL units to be sent through
/// the RDPGFX `WireToSurface1` PDU with `Codec1Type::Avc420`.
#[derive(Debug, Clone)]
pub struct Avc420Update {
